...
namespace shenlan
{
  ...
  bool PathPlanningNode::init()
  {
    ...
    csp_obj_ = std::make_unique<Spline2D>(wx_, wy_);
  ...
  {
    std::vector<Poi_f> obstcles{{179.76455688476562, -138.67462158203125}, {103.896484375, -187.98513793945312}};
